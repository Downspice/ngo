...
const projects: ProjectCard[] = [
  ...
  },
  {
    ...
    bodyImageSrc: "/logo.png",
    conclusion:
      "The Environmental Education Project has successfully raised awareness about environmental issues and inspired children to take action in their communities. Moving forward, we plan to develop new projects focused on climate change and renewable energy. By educating children about environmental stewardship, we are helping to create a sustainable future for everyone.",
    conclusionImageSrc: "/logo.png",
  },
  {
    id: 11,
  ...
  },
  {
    ...
    description:
      "Encouraging community involvement and volunteerism to support local projects.",
    imageSrc: "/logo.png",
    introduction:
      "Community involvement is crucial for creating sustainable change and fostering a sense of ownership among local residents. The Community Engagement and Volunteering program was developed to encourage individuals to contribute their time and skills to support local projects and improve their communities.",
    introductionImageSrc: "/logo.png",
    body: "The program provides opportunities for community members to get involved in various projects, such as organizing events, leading workshops, and participating in cleanup drives. We also offer training and support for volunteers to help them effectively contribute to our projects. By building a network of engaged citizens, we aim to strengthen community ties and empower individuals to make a positive impact.",
    bodyImageSrc: "/logo.png",
    conclusion:
    ...
    <>
      ...
      <div className=" grid grid-cols-2 gap-4 ">
        <div className="col-span-1 flex flex-row-reverse">
          <Image
            src={project.introductionImageSrc}
            alt={`${project.title} introduction`}
            width={100}
            height={100}
          />
        </div>
        ...
        <div className="col-span-1 flex justify-end">
          <Image
            src={project.conclusionImageSrc}
            alt={`${project.title} conclusion`}
            width={100}
            height={100}
          />
        </div>
